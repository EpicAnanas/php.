...
<body>
	...
	<form name="klantgegevens" action="<?php echo $_SERVER['PHP_SELF']; ?>" 
	method="post">
	<table border=1>
		<tr>
			<td colspan="2">
		...
		<input type="image" src="http://www.clker.com/cliparts/h/2/J/m/4/o/send-button-md.png" value="send" style="width:100px; height:60px"/>
	</form>
	<?php
