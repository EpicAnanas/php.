...
<body>
	...
	<hr />
		...
		<tr>
			<td><!--Shopping Cart Begin van Toshiba-->
				...
				<input type="image" name="betaal" src="http://www.torq-king.nl/images/users/18045/bestelknop.png" style=width:70px;height:50px border=0 value="send" />
	...
	<table border=1>
		...
		<input type="image" name="betaal" src="http://www.clker.com/cliparts/h/2/J/m/4/o/send-button-md.png" value="send" style="width:100px; height:60px"/>
	</form>
	<?php
